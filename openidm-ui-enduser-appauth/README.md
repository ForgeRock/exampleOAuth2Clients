...
The only other change to the IDM code that this example is based on is here: [ServiceInvoker.js](./org/forgerock/commons/ui/common/main/ServiceInvoker.js#L49)
