...
extension WebViewController {
    ...
    func saveCookies(_ cookies: [HTTPCookie]) {
        ...
        // `appGroup` can be used to identify a shared database.
        // If `appGroup` is not defined, the `UserDefaults.standard` object, specific to the current app and user,
        // is populated, and no inter-app data exchange is possible via `UserDefaults`.
