...
define(["jquery", "underscore", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/openidm/ui/common/delegates/ResourceDelegate", "org/forgerock/openidm/ui/common/util/ResourceCollectionUtils", "org/forgerock/commons/ui/common/util/ModuleLoader"], function ($, _, AbstractView, constants, resourceDelegate, resourceCollectionUtils, ModuleLoader) {
    var ResourceCollectionRelationshipsView = AbstractView.extend({
        ...
        render: function render(args, callback) {
            ...
            $.when(resourceDelegate.searchResource(args.prop.propName + ' eq "' + args.prop.parentId + '"&_pageSize=100&_sortKeys=' + args.prop.resourceCollection.query.fields.toString(), args.prop.resourceCollection.path), ModuleLoader.load("d3")).then(_.bind(function (qry, d3) {
