...
define(["jquery", "underscore", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/util/UIUtils", "org/forgerock/openidm/ui/common/util/BootstrapDialogUtils", "org/forgerock/openidm/ui/common/util/ResourceCollectionUtils"], function ($, _, AbstractView, conf, eventManager, constants, uiUtils, BootstrapDialogUtils, ResourceCollectionUtils) {
    var ResourceCollectionSearchDialog = AbstractView.extend({
        ...
        loadTemplate: function loadTemplate() {
            uiUtils.renderTemplate(this.template, this.currentDialog, _.extend({}, conf.globalData, this.data), _.bind(function () {
                ...
                this.model.dialogRef.$modalBody.on("keydown", _.bind(this.keydownHandler, this));
            }, this), "replace");
        },
        ...
        setupResourceTypeField: function setupResourceTypeField(typePath) {
            ...
            } else if (!this.data.property.resourceCollection.length) {
        ...
        */
        ...
        keydownHandler: function keydownHandler(event) {
            if (event.key === "Enter" && !$(event.target).parent().hasClass("selectize-input")) {
                this.model.dialogRef.$modal.find("#resourceCollectionSearchDialogSaveBtn").click();
            }
        }
    });
